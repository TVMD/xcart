...
/* /var/www/next/output/xcart/src/skins/customer/layout/header/mobile_header_parts/language_menu.twig */
class __TwigTemplate_e0290a2191aa9e395855aa0f4b4b09ba3d27e49e39e8d6b822603fe2ed3db1c4 extends \XLite\Core\Templating\Twig\Template
{
...
";
        // line 7
        if ($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "isNeedLanguageDropDown", array(), "method")) {
            // line 8
    ...
    <ul id=\"language_box\" class=\"dropdown-menu\">
      <li role=\"presentation\">
          <ul class=\"language_list\">
              ";
            // line 23
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget_list')->getCallable(), array($this->env, $context, array(0 => "header.language.menu"))), "html", null, true);
            echo "
          </ul>
      </li>
    </ul>
...
";
    ...
    {
        return "/var/www/next/output/xcart/src/skins/customer/layout/header/mobile_header_parts/language_menu.twig";
    }
...
/*  # Header right box*/
/*  #*/
/*  # @ListChild (list="layout.header.mobile.menu", weight="400")*/
/*  #}*/
/* */
/* {% if this.isNeedLanguageDropDown() %}*/
/*   <li class="dropdown mobile_header-language_menu">*/
/*     <a id="language_menu" class="dropdown-toggle" data-toggle="dropdown" href="#">*/
/*         <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="-8 12 20 20" enable-background="new -8 12 20 20" xml:space="preserve">*/
/*             <path display="none" fill="none" d="M-8,12h20v20H-8V12z"/>*/
/*             <path d="M2,13.7c-4.6,0-8.3,3.7-8.3,8.3s3.7,8.3,8.3,8.3c4.6,0,8.3-3.7,8.3-8.3S6.6,13.7,2,13.7z M7.8,18.7H5.3c-0.3-1-0.6-2-1.2-3*/
...
/*       <li role="presentation">*/
/*           <ul class="language_list">*/
/*               {{ widget_list('header.language.menu') }}*/
/*           </ul>*/
/*       </li>*/
/*     </ul>*/
/*   </li>*/
