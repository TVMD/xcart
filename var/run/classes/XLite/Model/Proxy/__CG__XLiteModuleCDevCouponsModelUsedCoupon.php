...
class UsedCoupon extends \XLite\Module\CDev\Coupons\Model\UsedCoupon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'value', 'order', 'coupon', 'type', '_previous_state');
        }
    ...
    public function processRemove()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'processRemove', array());
