...
class Page extends \XLite\Module\CDev\SimpleCMS\Model\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'useCustomOG', 'ogMeta', 'showSocialButtons', 'id', 'enabled', 'image', 'cleanURLs', 'metaDescType', 'position', 'editLanguage', 'translations', '_previous_state');
        }
