...
class TabTranslation extends \XLite\Module\XC\CustomProductTabs\Model\Product\TabTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'brief_info', 'content', 'label_id', 'code', 'owner', '_previous_state');
        }
    ...
    public function setBriefInfo($brief_info)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBriefInfo', array($brief_info));
