 ...
 */
class XpcDataCell extends \XLite\Module\CDev\XPaymentsConnector\Model\Payment\XpcDataCell implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'data_id', 'name', 'value', 'transaction', '_previous_state');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (XpcDataCell $proxy) {
