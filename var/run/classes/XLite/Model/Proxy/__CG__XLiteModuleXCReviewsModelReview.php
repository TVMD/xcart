...
class Review extends \XLite\Module\XC\Reviews\Model\Review implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'review', 'response', 'rating', 'additionDate', 'responseDate', 'profile', 'respondent', 'reviewerName', 'status', 'product', 'useForMeta', 'isNew', 'xcPendingExport', 'reviewKey', '_previous_state');
        }
